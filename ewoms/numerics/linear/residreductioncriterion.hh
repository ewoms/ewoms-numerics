...
public:
     ...
     */
    void setInitial(const Vector& curSol EWOMS_UNUSED, const Vector& curResid)
    {
     ...
     */
    void update(const Vector& curSol EWOMS_UNUSED,
                const Vector& changeIndicator EWOMS_UNUSED,
