...
#include <ewoms/numerics/linear/istlsparsematrixadapter.hh>
#include <ewoms/numerics/linear/overlappingbcrsmatrix.hh>
#include <ewoms/numerics/linear/overlappingblockvector.hh>
#include <ewoms/numerics/linear/overlappingpreconditioner.hh>
#include <ewoms/numerics/linear/overlappingscalarproduct.hh>
#include <ewoms/numerics/linear/overlappingoperator.hh>
#include <ewoms/numerics/linear/parallelbasebackend.hh>
#include <ewoms/numerics/linear/istlpreconditionerwrappers.hh>
...
protected:
    ...
    std::shared_ptr<ParallelPreconditioner> preparePreconditioner_()
    {
        ...
        if (!preconditionerIsReady)
            throw Ewoms::NumericalIssue("Creating the preconditioner failed");
