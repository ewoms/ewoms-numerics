...
public:
     ...
     */
    void sendBorderIndex(ProcessRank peerRank EWOMS_UNUSED_NOMPI,
                         Index domesticIdx EWOMS_UNUSED_NOMPI,
                         Index peerLocalIdx EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
     ...
     */
    void receiveBorderIndex(ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
...
protected:
    ...
    void sendBorderTo_(ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
    ...
    void receiveBorderFrom_(ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
