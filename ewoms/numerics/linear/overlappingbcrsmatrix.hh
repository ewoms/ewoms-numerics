...
#include <ewoms/numerics/linear/domesticoverlapfrombcrsmatrix.hh>
#include <ewoms/numerics/linear/globalindices.hh>
#include <ewoms/numerics/linear/blacklist.hh>
#include <ewoms/common/parallel/mpibuffer.hh>
...
public:
    ...
    // Dune >= 2.7.
    OverlappingBCRSMatrix(size_t numRows EWOMS_UNUSED,
                          size_t numCols EWOMS_UNUSED,
                          typename BCRSMatrix::BuildMode buildMode EWOMS_UNUSED)
...
private:
    ...
    template <class NativeBCRSMatrix>
    void sendIndices_(const NativeBCRSMatrix& nativeMatrix EWOMS_UNUSED_NOMPI,
                      ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
    ...
    void receiveIndices_(ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
    ...
    void sendEntries_(ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
    ...
    void receiveAddEntries_(ProcessRank peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
    ...
    void receiveCopyEntries_(int peerRank EWOMS_UNUSED_NOMPI)
    {
#if HAVE_MPI
