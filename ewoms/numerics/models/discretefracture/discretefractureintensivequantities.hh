...
#include <ewoms/numerics/models/immiscible/immiscibleintensivequantities.hh>
...
public:
    ...
    void update(const ElementContext& elemCtx, unsigned vertexIdx, unsigned timeIdx)
    {
        ...
        Ewoms::Valgrind::SetUndefined(fractureFluidState_);
        Ewoms::Valgrind::SetUndefined(fractureVolume_);
        Ewoms::Valgrind::SetUndefined(fracturePorosity_);
        Ewoms::Valgrind::SetUndefined(fractureIntrinsicPermeability_);
        Ewoms::Valgrind::SetUndefined(fractureRelativePermeabilities_);
