...
public:
     ...
     */
    Scalar primaryVarWeight(unsigned globalDofIdx EWOMS_UNUSED, unsigned pvIdx) const
    {
     ...
     */
    Scalar eqWeight(unsigned globalDofIdx EWOMS_UNUSED, unsigned EWOMS_OPTIM_UNUSED eqIdx) const
    {
        unsigned EWOMS_OPTIM_UNUSED compIdx = eqIdx - Indices::contiEqIdx;
