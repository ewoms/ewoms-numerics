...
#include <ewoms/numerics/io/restart.hh>
...
public:
     ...
     */
    static int handlePositionalParameter(std::set<std::string>& seenParams EWOMS_UNUSED,
                                         std::string& errorMsg,
    ...
    void boundary(BoundaryRateVector& values EWOMS_UNUSED,
     ...
     */
    template <class Context>
    void constraints(Constraints& constrs EWOMS_UNUSED,
                     const Context& context EWOMS_UNUSED,
                     unsigned spaceIdx EWOMS_UNUSED,
                     unsigned timeIdx EWOMS_UNUSED) const
     ...
     */
    template <class Context>
    void source(RateVector& rate EWOMS_UNUSED,
                const Context& context EWOMS_UNUSED,
                unsigned spaceIdx EWOMS_UNUSED,
                unsigned timeIdx EWOMS_UNUSED) const
     ...
     */
    template <class Context>
    void initial(PrimaryVariables& values EWOMS_UNUSED,
                 const Context& context EWOMS_UNUSED,
                 unsigned spaceIdx EWOMS_UNUSED,
                 unsigned timeIdx EWOMS_UNUSED) const
     ...
     */
    template <class Context>
    Scalar extrusionFactor(const Context& context EWOMS_UNUSED,
                           unsigned spaceIdx EWOMS_UNUSED,
                           unsigned timeIdx EWOMS_UNUSED) const
    ...
    void finalize()
    {
        ...
        unsigned threadsPerProcess = std::max(1, this->simulator().taskletRunner().numWorkerThreads());
