...
public:
     ...
     *                time discretization.
     */
    const Stencil& stencil(unsigned timeIdx EWOMS_UNUSED) const
    { return stencil_; }
     ...
     *                time discretization.
     */
    const GlobalPosition& pos(unsigned dofIdx, unsigned timeIdx EWOMS_UNUSED) const
     ...
     * \param timeIdx The index of the solution vector used by the time discretization.
     */
    const ExtensiveQuantities& extensiveQuantities(unsigned fluxIdx, unsigned timeIdx EWOMS_UNUSED) const
